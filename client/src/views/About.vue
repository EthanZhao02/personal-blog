    ...
    <div class="about-inner">
      ...
      <main class="about-main">
        ...
        <section class="about-section">
          ...
          <p class="about-bio">{{ siteConfig.about.bio }}</p>
        </section>

        <section class="about-section" v-if="siteConfig.about.skills?.length">
          <h2 class="section-title">技能</h2>
          <div class="skill-list">
            <span
              v-for="skill in siteConfig.about.skills"
              :key="skill"
              class="skill-chip"
            >{{ skill }}</span>
          </div>
        ...
        <section class="about-section" v-if="siteConfig.about.interests?.length">
          <h2 class="section-title">兴趣</h2>
          <div class="skill-list">
            <span
              v-for="item in siteConfig.about.interests"
              :key="item"
              class="skill-chip interest"
            >{{ item }}</span>
          </div>
        </section>
        ...
        <section class="about-section" v-if="siteConfig.wechatPay || siteConfig.alipay">
          ...
          <div class="donate-qr">
            <div class="qr-item" v-if="siteConfig.wechatPay">
              ...
              <img :src="siteConfig.wechatPay" alt="微信收款码" />
            </div>
            <div class="qr-item" v-if="siteConfig.alipay">
              <p class="qr-label">支付宝</p>
              <img :src="siteConfig.alipay" alt="支付宝收款码" />
            </div>
          </div>
        </section>
      </main>
      ...
      <aside class="about-aside">
        ...
        <div class="aside-card">
          <p class="aside-card-title">联系方式</p>
          <div class="contact-list">
            <a
              ...
              class="contact-item"
            >
              <span v-html="getIcon(social.icon)"></span>
...
const getIcon = (icon) => {
  const icons = {
    ...
    default: '<span class="social-letter">--</span>',
  }
...
.skill-chip:hover {
  background: rgba(56, 248, 255, 0.22);
