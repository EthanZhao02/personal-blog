...
const getSocialIcon = (icon) => {
  const icons = {
    ...
    juejin: '<span style="font-size:13px;font-weight:800">掘</span>',
    leetcode: '<span style="font-size:11px;font-weight:800">LC</span>',
    wechat: '<span style="font-size:13px;font-weight:800">微</span>',
    qq: '<span style="font-size:11px;font-weight:800">QQ</span>',
    gitlab: '<span style="font-size:13px;font-weight:700">GL</span>',
    gitee: '<span style="font-size:13px;font-weight:700">GE</span>',
    csdn: '<span style="font-size:13px;font-weight:700">CN</span>',
    yuque: '<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1.5 15.5h-2v-7h2v7zm5 0h-2v-4h-2v-3h4v7z"/></svg>',
  }
  return icons[icon] || '<span style="font-size:12px">--</span>'
}
</script>
